...
/// - génère les slots
/// - sélectionne un slot (visuel + logique)
/// - utilise l’item du slot sélectionné
/// - sauvegarde et recharge les items de la hotbar.
/// </summary>
public class HotBarController : MonoBehaviour
{
    /// <summary>
    /// Panel contenant les slots de la hotbar.
    /// </summary>
    public GameObject hotbarPanel;

    /// <summary>
    /// Prefab d’un slot de hotbar.
    /// </summary>
    ...
    /// <summary>
    /// Image de surbrillance indiquant le slot sélectionné.
    /// </summary>
    ...
    /// - configure les touches associées
    ...
    /// <summary>
    /// Utilise l’item contenu dans un slot donné.
    /// </summary>
